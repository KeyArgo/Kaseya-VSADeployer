...
ButtonInstallVSA:
    ...
    If (Row) {
		...
		if FileExist("C:\Program Files (x86)\Kaseya\KSAAS129213273326984\KASetup.exe"){
			MsgBox, VSA Agrent currently installed.  Uninstalling and reinstalling VSA Agent for %Practice%.
			RunWait , "C:\Program Files (x86)\Kaseya\KSAAS129213273326984\KASetup.exe" /s /r /g KSAAS129213273326984 /l "%TEMP%\kasetup.log"
		}
